...
@REM #
ngdbuild -p xc6slx45fgg676-2 -nt timestamp -bm battle_city.bmm "D:/RA512014/LPRS2/battle_city_fpga/battle_city_design/implementation/battle_city.ngc" -uc battle_city.ucf battle_city.ngd 
