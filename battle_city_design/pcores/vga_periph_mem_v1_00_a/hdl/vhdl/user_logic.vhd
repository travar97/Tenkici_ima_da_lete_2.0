...
architecture IMP of user_logic is
  ...
  constant REG_ADDR_00       : std_logic_vector(GRAPH_MEM_ADDR_WIDTH-1 downto 0) := x"00000";
  constant REG_ADDR_01       : std_logic_vector(GRAPH_MEM_ADDR_WIDTH-1 downto 0) := x"00001";
  constant REG_ADDR_02       : std_logic_vector(GRAPH_MEM_ADDR_WIDTH-1 downto 0) := x"00002";
  constant REG_ADDR_03       : std_logic_vector(GRAPH_MEM_ADDR_WIDTH-1 downto 0) := x"00003";
  constant REG_ADDR_04       : std_logic_vector(GRAPH_MEM_ADDR_WIDTH-1 downto 0) := x"00004";
  constant REG_ADDR_05       : std_logic_vector(GRAPH_MEM_ADDR_WIDTH-1 downto 0) := x"00005";
  constant REG_ADDR_06       : std_logic_vector(GRAPH_MEM_ADDR_WIDTH-1 downto 0) := x"00006";   
  constant REG_ADDR_07       : std_logic_vector(GRAPH_MEM_ADDR_WIDTH-1 downto 0) := x"00007";
  constant REG_ADDR_08       : std_logic_vector(GRAPH_MEM_ADDR_WIDTH-1 downto 0) := x"00008";


  constant update_period     : std_logic_vector(31 downto 0) := x"00000001";
  ...
  --USER signal declarations added here, as needed for user logic
	...
	signal unit_addr_s			: std_logic_vector(ADDR_WIDTH-1 downto 0);
	signal reg_we_s				: std_logic;
	signal v_sync_counter_tc_s : std_logic_vector(8 downto 0);
	signal interrupt_en_s      : std_logic;
...
begin
  ...
  interupt_o   <= '1' when ((interrupt_en = '1') and (v_sync_counter_tc = dir_pixel_row)) else '0'; 
  
  --USER logic implementation added here
  addr_s 		<= Bus2IP_Addr(ADDR_WIDTH+1 downto 2);
  data_s 		<= Bus2IP_Data(DATA_WIDTH-1 downto 0);
  reg_we_s		<= '1' when Bus2IP_WrCE(0) = '1' else '0';
